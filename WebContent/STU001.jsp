    ...
    <div id="sub_content">
        ...
        <form action="RegisterStuServlet" method="post">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name"   name="name" value="${stuBean.name}">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="date" class="form-control" id="dob"  name="dob" value="${stuBean.dob}"> 
                </div>
            </div>
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio"  id="gridRadios1"  name="gender" value="Male"
                            checked>
                    ...
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" id="gridRadios2"  name="gender"  value="Female">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="phone"  placeholder="+95"name="phone" value="${stuBean.phone }">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
